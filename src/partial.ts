...
export function partial<A1, A2, A3, R>(
  fn: (a: A1, a2: A2, a3: A3) => R,
  ...args: [A1, A2, A3]
): () => R;
export function partial<A1, A2, A3, R>(
  fn: (a: A1, a2: A2, a3: A3) => R,
...
export function partial<A1, A2, A3, A4, R>(
  fn: (a: A1, a2: A2, a3: A3, a4: A4) => R,
  ...args: [A1, A2, A3, A4]
): () => R;
export function partial<A1, A2, A3, A4, R>(
  fn: (a: A1, a2: A2, a3: A3, a4: A4) => R,
...
export function partialRight<A1, A2, R>(
  fn: (a: A1, a2: A2) => R,
  ...args: [A1, A2]
): () => R;
export function partialRight<A1, A2, R>(
...
export function partialRight<A1, A2, A3, R>(
  fn: (a: A1, a2: A2, a3: A3) => R,
  ...args: [A1, A2, A3]
): () => R;
export function partialRight<A1, A2, A3, R>(
...
export function partialRight<A1, A2, A3, A4, R>(
  fn: (a: A1, a2: A2, a3: A3, a4: A4) => R,
  ...args: [A1, A2, A3, A4]
): () => R;
export function partialRight<A1, A2, A3, A4, R>(
